...
<div class="container-fluid  dashboard-content">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">Manage Student</h2>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <h5 class="card-header">Manage Student {{-- <a class="adbtn btn btn-primary" title="Add new category" href="{{route('create.student')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add Student</a> --}}</h5>
                <div class="card-body">
                    <form action="{{route('manage.student')}}">
                        <div class="row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @endif --}}
                                        <a href="{{route('view.student',[$val->id])}}"><i class="fas fa-eye" title="View"></i></a>
                                        <a href="{{route('create.student',[$val->id])}}"><i class=" fas fa-edit" title="Edit"></i></a>
                                        <a href="{{route('delete.student',[$val->id])}}" onclick="return confirm('Do you want to delete this student ?')"><i class=" fas fa-trash" title="Delete"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
