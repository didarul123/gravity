...
<div class="container-fluid  dashboard-content">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">Manage Subject</h2>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <h5 class="card-header">Manage Subject <a class="adbtn btn btn-primary" title="Add new category" href="{{route('create.subject')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add Subject</a></h5>
                <div class="card-body">
                    <form action="{{route('manage.subject')}}">
                        <div class="row">
                                ...
                                <tr>
                                    ...
                                    {{-- <td class="sorting_1">
                                        <span class="userposted_imgBox">
                                            @if(@$val->image)
                                                <img src="{{asset('storage/app/subject/'.@$val->image)}}">
                                            @else
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('edit.subject',[$val->id])}}"><i class=" fas fa-edit" title="Edit"></i></a>
                                        <a href="{{route('delete.subject',[$val->id])}}" onclick="return confirm('Do you want to delete this class ?')"><i class=" fas fa-trash" title="Delete"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
