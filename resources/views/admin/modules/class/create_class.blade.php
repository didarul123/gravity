...
@section('title')
@if(@$class) Edit @else Add @endif Class
@endsection
@section('links')
...
<div class="container-fluid  dashboard-content">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">@if(@$class) Edit @else Add @endif Class</h2>
                <div class="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@if(@$class) Edit @else Add @endif Class</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <h5 class="card-header">@if(@$class) Edit @else Add @endif Class<a class="adbtn btn btn-primary" href="{{route('manage.class')}}"><i class="fa fa-angle-left" aria-hidden="true"></i> Back</a></h5>
                <div class="card-body">
                    <form action="{{route('store.class')}}" method="post" id="teacherform" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-xl-12 col-lg-12 col-md-6 col-sm-3 col-12">
                                ...
                                <button type="submit" class="btn btn-primary search_btnUser">@if(@$class) Update @else Save @endif</button>
                            </div>
                        </div>
                    </form>
                </div>
