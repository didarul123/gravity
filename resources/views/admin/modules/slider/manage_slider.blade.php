...
<div class="container-fluid  dashboard-content">
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="page-header">
                <h2 class="pageheader-title">Manage Slider</h2>
    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="card">
                <h5 class="card-header">Manage Slider <a class="adbtn btn btn-primary" title="Add new category" href="{{route('create.slider')}}"><i class="fa fa-plus" aria-hidden="true"></i> Add Slider</a></h5>
                <div class="card-body">
                    <form action="{{route('manage.slider')}}">
                        <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td class="sorting_1">
                                        <span class="userposted_imgBox">
                                            @if(@$val->image)
                                                <img src="{{asset('storage/app/slider/'.@$val->image)}}">
                                            @else
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('create.slider',[$val->id])}}"><i class=" fas fa-edit" title="Edit"></i></a>
                                        <a href="{{route('delete.slider',[$val->id])}}" onclick="return confirm('Do you want to delete this slider ?')"><i class=" fas fa-trash" title="Delete"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
