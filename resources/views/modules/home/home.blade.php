                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                             ...
                             <div class="col-xl-6 col-lg-5 col-md-12">
                                ...
                                <img src="{{asset('storage/app/slider/'.@$slider->image)}}"></div></div>
                        </div>
                    </div>          
                </div>
                @endforeach
   ...
   <section class="courses-area section-padding40 fix">
       <div class="container">
          ...
          <div class="properties pb-40">
              ...
              <div class="col-sm-12 col-lg-12 col-md-12"><div class="max-600"><a href="{{route('course')}}" class="border-btn border-btn1">More Courses</a></div></div>
